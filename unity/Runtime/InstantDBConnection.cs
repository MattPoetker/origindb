...
{
    /// <summary>
    /// Unity implementation of InstantDB connection using WebSocket.
    /// </summary>
    public class InstantDBConnection : IInstantDBConnection
    {
        private readonly InstantDBConnectionOptions _options;
        ...
        public InstantDBConnection(InstantDBConnectionOptions options)
        {
            ...
            {
                Debug.Log($"[InstantDB] Connection created for {_options.ServerUrl}");
            }
        }
        ...
        public async Task ConnectAsync()
        {
            try
            {
                ...
                if (_options.EnableLogging)
                {
                    Debug.Log($"[InstantDB] Connecting to {_options.ServerUrl}...");
                }
                ...
                if (_options.EnableLogging)
                {
                    Debug.Log($"[InstantDB] Connected successfully to {_options.ServerUrl}");
                }
            ...
            catch (Exception ex)
            {
                ...
                if (_options.EnableLogging)
                {
                    Debug.LogError($"[InstantDB] Connection failed: {ex.Message}");
                }
        ...
        public void Disconnect()
        {
            try
            {
                ...
                if (_options.EnableLogging)
                {
                    Debug.Log($"[InstantDB] Disconnected from {_options.ServerUrl}");
                }
        ...
        public async Task SubscribeToTable(string tableName)
        {
            ...
            if (_options.EnableLogging)
            {
                Debug.Log($"[InstantDB] Subscribed to table: {tableName}");
            }
        }
        ...
        public async Task SubscribeToAllTables()
        {
            ...
            if (_options.EnableLogging)
            {
                Debug.Log("[InstantDB] Subscribed to all tables");
            }
        }
        ...
        public void Pause()
        {
            ...
            if (_options.EnableLogging)
            {
                Debug.Log("[InstantDB] Connection paused");
            }
        }
        ...
        public void Resume()
        {
            ...
            if (_options.EnableLogging)
            {
                Debug.Log("[InstantDB] Connection resumed");
            }
        }
        ...
        private void ProcessMessage(string message)
        {
            try
            {
                if (_options.EnableLogging)
                {
                    Debug.Log($"[InstantDB] Received: {message}");
                }
                ...
                switch (messageType)
                {
                    ...
                    default:
                        if (_options.EnableLogging)
                        {
                            Debug.LogWarning($"[InstantDB] Unknown message type: {messageType}");
                        }
                        break;
                }
            }
        ...
        private void ProcessInitialState(Dictionary<string, object> messageObj)
        {
            if (_options.EnableLogging)
            {
                Debug.Log("[InstantDB] Received initial state");
            }
