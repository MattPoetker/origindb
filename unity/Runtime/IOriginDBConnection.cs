...
{
    /// <summary>
    /// Interface for OriginDB connections that integrates with Unity's lifecycle.
    /// </summary>
    public interface IOriginDBConnection
    {
        /// <summary>
        ...
        /// <summary>
        /// Connect to the OriginDB server asynchronously.
        /// </summary>
        Task ConnectAsync();
