...
/**
 * OriginDB C++ SDK for WebAssembly Modules
 *
...
// =============================================================================
// Host API - Low-level interface to OriginDB
// =============================================================================

namespace host {

// External functions provided by OriginDB host (imported from WASM)
extern "C" {
    // Database operations
 ...
 */
ORIGINDB_EXPORT bool filter_event(const std::vector<uint8_t>& event_data) {
 ...
 */
ORIGINDB_EXPORT std::vector<uint8_t> transform_event(const std::vector<uint8_t>& event_data) {
 ...
 */
ORIGINDB_EXPORT std::vector<uint8_t> get_initial_data(const std::string& where_clause) {
 ...
 */
ORIGINDB_EXPORT void emit_to_client(const std::string& client_id,
 ...
 *
 * Usage:
 * ORIGINDB_REDUCER(my_function, int64_t user_id, std::string name) {
 *     // Reducer implementation
 *     return Result<std::string>{"success"};
 * }
 */
#define ORIGINDB_REDUCER(name, ...) \
 ...
 */
#define ORIGINDB_EXPORT extern "C" __attribute__((visibility("default")))

/**
 * Declare module initialization function
 */
#define ORIGINDB_INIT() \
    ORIGINDB_EXPORT int32_t module_init()

/**
 * Declare client connection handler
 */
#define ORIGINDB_CLIENT_CONNECTED() \
    ORIGINDB_EXPORT int32_t client_connected(const char* connection_id)

/**
 * Declare client disconnection handler
 */
#define ORIGINDB_CLIENT_DISCONNECTED() \
    ORIGINDB_EXPORT int32_t client_disconnected(const char* connection_id)
