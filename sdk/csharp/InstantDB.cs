// =============================================================================
// InstantDB C# WASM Module SDK
//
// Single-file SDK for writing InstantDB server-side modules in C#, targeting
// .NET 8 / wasi-wasm (Mono, `wasi-experimental` workload). Compile this file
// into your module project:
//
//   <Compile Include="path/to/sdk/csharp/InstantDB.cs" />
//
// It implements the InstantDB WASM ABI v1 (docs/WASM_ABI.md):
//
...
//     instantdb_describe, instantdb_invoke — implemented once, here, with
//     [UnmanagedCallersOnly]. Your module must NOT define them again.
//   * A ReducerRegistry (see `Reducers`) that instantdb_invoke dispatches
...
// the registry is always populated before the host's first instantdb_invoke /
// instantdb_describe call, regardless of whether the host runs `_initialize`,
// `_start`, or neither.
// =============================================================================
...
namespace InstantDB
{
    ...
    internal static unsafe class Mem
    {
        ...
        /// instantdb_alloc (which uses NativeMemory.Alloc — same allocator).
        /// </summary>
    ...
    public static class Reducers
    {
        ...
        /// <summary>Module name/version reported by instantdb_describe.</summary>
        ...
        /// <summary>Declare a table for instantdb_describe metadata (informational).</summary>
    ...
    public static unsafe class ModuleExports
    {
        ...
        /// by the guest and freed with NativeMemory.Free / instantdb_free.
        /// </summary>
        [UnmanagedCallersOnly(EntryPoint = "instantdb_alloc")]
        ...
        [UnmanagedCallersOnly(EntryPoint = "instantdb_free")]
        ...
        [UnmanagedCallersOnly(EntryPoint = "instantdb_describe")]
        ...
        /// </summary>
        [UnmanagedCallersOnly(EntryPoint = "instantdb_invoke")]
        public static int InstantDbInvoke(nint namePtr, int nameLen, nint argsPtr, int argsLen)
        {
            ...
            try
            {
                ...
                // The host wrote name/args via instantdb_alloc; the guest owns
            ...
            catch (Exception ex)
            {
                try
                {
                    Host.LogError($"unhandled exception in instantdb_invoke('{name}'): {ex}");
                }
                catch
                {
