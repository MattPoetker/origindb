// OriginDB benchmark suite — stable, repeatable baselines for regression
...
//
// Usage: origindb_bench [--out results.json] [--fixture tests/wasm/fixtures/test_module.wat]
//
// Coverage:
...
int main(int argc, char** argv) {
    ...
    std::cout << "OriginDB benchmark suite" << std::endl;
